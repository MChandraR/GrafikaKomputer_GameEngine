...
class gameobject{
    gameObjects = [];
    constructor(){
       this.objects = [{"id":"0","name":"Game Object 0","type":"1","gravity":"5","fill":"Blue","absolute":1,"collisionBlock":1,"tipe":1,"transform":{"x":0.0,"y":5.0,"xSize":50.0,"ySize":50.0},"audio":{"source":[{"name":"bit jump.mp3","path":"game/asset/bit jump.mp3"},{"name":"sfx.mp3","path":"game/asset/sfx.mp3"}],"loop":0,"volume":3,"selectedTrack":1},"texture":{"sources":[{"name":"mario.png","path":"game/asset/mario.png"},{"name":"mario2.png","path":"game/asset/mario2.png"}],"selectedTexture":-1}},{"id":"1","name":"Game Object 1","type":"1","gravity":"0","fill":"Blue","absolute":1,"collisionBlock":1,"tipe":1,"transform":{"x":0.0,"y":400.0,"xSize":400.0,"ySize":50.0},"audio":{"source":[],"loop":0,"volume":1,"selectedTrack":-1},"texture":{"sources":[],"selectedTexture":0}}] ;
...
class object extends transform{
    ...
    constructor(id,name,sizeX,sizeY,x,y,tipe,gravity, absolute, collisionBlock, fill, volume, selectedTrack, track, textures){
        super();
        this.id = id;
        this.name = name;
        this.sizeX = sizeX;
